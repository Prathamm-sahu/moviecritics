...
import { Loader, SquarePen, Trash, Trash2 } from "lucide-react";
      ...
      <main className="">
        <div className="bg-white rounded-lg p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            {movie?.averageRating && <span className=" text-xl md:text-4xl font-bold text-indigo-600">{`${movie?.averageRating}/10`}</span>}
          </div>
            ...
            >
              ...
              <div className="flex justify-between items-center ">
                ...
                <div className="space-x-2">
                  ...
                  <DeleteModal ratingId={id} handleDelete={handleDelete} item="review">
                    <button className="hover:text-indigo-600">
